...
// Create sidebar context for state management
...
>(
  (
    ...
    // Internal state management for sidebar
...
// Define styling variants for sidebar menu buttons
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Generate random width for skeleton loading
